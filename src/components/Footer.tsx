              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-primary-200">
                    {config.phoneNumber} <span className="text-primary-400 font-medium">Anexo {config.phoneAnnex}</span>
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-primary-200 leading-snug">
                    ...
                    <a href={`mailto:${config.emailInstitutional}`} className="hover:underline">{config.emailInstitutional}</a>
                  </p>
                  <p className="text-xs text-primary-200 leading-snug mt-1.5">
                    <span className="text-primary-400 font-medium">Consultas:</span><br />
                    <a href={`mailto:${config.emailClientQuery}`} className="hover:underline">{config.emailClientQuery}</a><br />
                    <a href={`mailto:${config.emailApplicantQuery}`} className="hover:underline">{config.emailApplicantQuery}</a>
                  </p>
                </div>
              </div>
            </div>
